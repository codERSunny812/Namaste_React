...
const Title = () => (
 <a href="/">
   <img  src="https://obs.line-scdn.net/0m0339dd5b72513e8a8d6127b836e5ecf1e128f1da5cb7?0" className="logo"/>
 </a>
);
...
// previous static data for the cards
// const FoodData = {
//    Name:"Vaangoo",
//    image:"https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/gd3htbxibzdfllrtvcq5",
//    origin:"south indian",
//    rating:"4.2",
//    time:"32min",
//    rate:"350 for two"
...
// RestaurantList is JSON Data for displaying cards of swiggy
...
const Body = () =>{
   return(
      ...
      <RestrauCard  restaurant={restaurantList[4]}/>
      <RestrauCard  restaurant={restaurantList[5]}/>
      <RestrauCard  restaurant={restaurantList[6]}/>
      <RestrauCard  restaurant={restaurantList[7]}/>
      <RestrauCard  restaurant={restaurantList[8]}/>
      <RestrauCard restaurant={restaurantList[9]} />
      <RestrauCard  restaurant={restaurantList[10]} />
